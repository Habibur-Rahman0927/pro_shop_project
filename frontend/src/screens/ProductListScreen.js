...
import { createProduct, deleteProduct, listProducts } from '../actions/actions';
        ...
        <>
            <Row className="align-items-center">
                ...
                <Col className="text-right">
                    <Button className="my-3 createBtn" onClick={createProductHandler}><i className="fas fa-plus"></i> Create Product</Button>
                </Col>
            </Row>
